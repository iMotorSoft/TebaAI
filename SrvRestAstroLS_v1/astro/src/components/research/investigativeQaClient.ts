...
export interface ResearchResponse { status: "ok" | "partial" | "no_evidence"; intent?: ResearchIntent; interpretation?: QueryInterpretation; query_resolution?: QueryResolution; answer_text: string; answer_markdown: string; summary: string; conversation: { conversation_id: string | null; turn_id: string | null; resolved_context?: string[] }; works_consulted: string[]; hits: Hit[]; claims: Claim[]; primary_evidence_ids: string[]; evidence_counts: EvidenceCounts; evidence_matrix: MatrixRow[]; cross_corpus_matrix: MatrixRow[]; warnings: string[]; not_found: string[]; execution: Record<string, unknown>; }

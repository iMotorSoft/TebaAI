...
export const literalMatchKindLabels: Record<string, string> = {
  ...
  body_literal_exact: "Cita literal exacta del cuerpo",
  footnote_literal_exact: "Cita literal exacta de nota al pie",
  printed_reference_exact: "Referencia impresa exacta",
  printed_reference_normalized: "Referencia impresa normalizada",
  heading_normalized: "Encabezado normalizado",
  heading_accent_folded: "Encabezado sin distinción de acentos",
  literal_search_normalized: "Búsqueda literal normalizada",
  search_normalized: "Búsqueda normalizada",
  english_name_exact: "Nombre propio en inglés exacto",
  english_name_normalized: "Nombre propio en inglés normalizado",
  english_name_partial: "Nombre propio en inglés parcial",
  english_name_all_tokens_ordered: "Todos los términos del nombre en inglés en orden",
  english_name_all_tokens_proximity: "Términos del nombre en inglés en proximidad",
  hebrew_exact_normalized: "Coincidencia hebrea exacta normalizada",
  hebrew_all_tokens_ordered: "Todos los términos hebreos en orden",
  hebrew_all_tokens_proximity: "Términos hebreos en proximidad",
